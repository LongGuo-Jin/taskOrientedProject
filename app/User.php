...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
       'organization_id', 'nameFirst', 'nameMiddle' , 'nameFamily','roleID' ,'gender','birthday','addressType','address','phone_number','description','addressID','administrativeID' ,
        'email', 'password', 'nameTag','avatarType','avatarColor','avatarColorValue','locale' , 'filter_order'
    ];
