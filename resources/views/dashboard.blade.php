                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="kt-portlet  kt-portlet--tabs">
                            ...
                            @foreach($taskList['unread'] as $columnClass => $columnItem)
                                <div class="column-body" data-column_id="{{$columnClass}}">
                                    @if(isset($columnItem["ID"]))
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="kt_regular_tab_{{$columnClass}}">
                                                <div class="kt-regular-task-item thin"
                                                    ...
                                                    <div style="width: 90%; padding: 10px">
                                                        <div class="row m-2">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <x-user-avatar :type="$columnItem['avatarType']" :nameTag="$columnItem['nameTag']" :roleID="$columnItem['roleID']" :color="$columnItem['avatarColor']" />                                                            </div>
                                                        </div>
                                                        <div class="kt-space-10"></div>
                                                        <div class="progress" style="height: 6px;">
                                                            @if($columnItem["statusID"] == 4)
