    ...
    <div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
            <ul class="kt-menu__nav " >
                ...
                <li class="kt-menu__item <?php echo e(isset($dashboard)?"header_menu_item_active":""); ?>  header_menu_item " data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                    <a href="<?php echo e(route('dashboard')); ?>" class="header_menu_item_link">
                        <span class="kt-menu__link-text top-menu "><i class="fa fa-dot-circle header_menu_item_icon"></i><?php echo e(__('main.dashboard')); ?></span>
                    </a>
                </li>
        ...
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                <div class="kt-header__topbar-user header_menu_item">
                    ...
                    <?php switch(auth()->user()->avatarType):
                    case (1): ?>
                        <svg width="32" height="32">
                            <circle cx="16" cy="16" r="16" stroke="black" stroke-width="0" fill="<?php echo e(auth()->user()->avatarColor); ?>"></circle>
                            <text x="5" y="22"  style="fill:black;font-size: 16px"><?php echo e(auth()->user()->nameTag); ?></text>

                        <?php break; ?>
                    <?php case (2): ?>
                        
                        <svg width="32" height="32">
                            <rect x="0" y="0" rx="5" ry="5" width="32" height="32" fill="<?php echo e(auth()->user()->avatarColor); ?>" style="stroke-width:0;"></rect>
                            <text x="5" y="22" style="fill:black;font-size: 16px"><?php echo e(auth()->user()->nameTag); ?></text>
                    ...
                    <?php case (3): ?>
                        ...
                        <svg width="32" height="32">
                            <polygon points="16,0 0.78309703188832,11.055724111756 6.5954291951265,28.944266992616 25.404553884384,28.944279286068 	31.216909431155,11.055744002985 " fill="<?php echo e(auth()->user()->avatarColor); ?>" style="stroke:purple;stroke-width:0;"></polygon>
                            <text x="5" y="22" style="fill:black;font-size: 16px"><?php echo e(auth()->user()->nameTag); ?></text>
                    ...
                    <?php case (4): ?>
                        ...
                        <svg width="32" height="32" >
                            <polygon points="8.000001509401,2.143592667996 8.5442763975152E-13,15.999994771282 7.9999924529963,29.856402103284 23.999989434191,29.856412560718 	31.999999999992,16.000015686155 24.000016603405,2.1436031254426 "  fill="<?php echo e(auth()->user()->avatarColor); ?>" style="stroke:purple;stroke-width:0;"></polygon>
                            <text x="5" y="22" style="fill:black;font-size: 16px"><?php echo e(auth()->user()->nameTag); ?></text>
                    ...
                    <?php case (5): ?>
                        ...
                        <svg width="32" height="32">
                            <polygon points="8.5442763975152E-13,15.999994771282 15.999989542563,31.999999999997 31.999999999992,16.000015686155 	16.000020914873,1.3669065879185E-11 " fill="<?php echo e(auth()->user()->avatarColor); ?>" style="stroke:purple;stroke-width:0;"></polygon>
                            <text x="5" y="22" style="fill:black;font-size: 16px"><?php echo e(auth()->user()->nameTag); ?></text>

                        <?php break; ?>
                    <?php endswitch; ?>
                    <?php switch(auth()->user()->roleID):
                        case (1): ?>
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                ...
                <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-color: #0a6aa1">
                    ...
                    <div class="kt-user-card__name">
                        <?php echo e(auth()->user()->nameFamily); ?> &nbsp; <?php echo e(auth()->user()->nameFirst); ?>
