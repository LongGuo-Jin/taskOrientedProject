<div class="col-md-3">
    ...
    <div class="list-card">
        <div style="display: flex; justify-content: space-between;font-size: 22px; color: #464e74;">
            <span <?php echo e($system != 1?"id=tagNameEdit":""); ?>> <?php echo e($tags['selected']['name']); ?> </span>
            <?php if($system != 1): ?>
            ...
            <?php else: ?>
                <?php if($tags['selected']['pinned'] == 0): ?>
                    <a href="<?php echo e(route('tag.updatePin',['tagID'=>$selected])); ?>"><i class="la la-gavel mt-auto mb-auto font-weight-bold" style="cursor: pointer; color: green; font-size: 25px"></i></a>
                <?php else: ?>
                    <a href="<?php echo e(route('tag.updatePin',['tagID'=>$selected])); ?>"><i class="la la-gavel mt-auto mb-auto font-weight-bold" style="cursor: pointer; color: red; font-size: 25px"></i></a>
                <?php endif; ?>
            <?php endif; ?>
        ...
        <div class="row mt-3">
                <div class="ml-2">
                    ...
                    <div class="ml-2" style="display: flex">
                        <input type="radio" id="system-radio" <?php echo e($tags['selected']['tagtype'] == 1?"checked":""); ?> disabled class="mt-1 mr-3"> <span> <h5>System Tag</h5></span>
                    </div>
                    <div class="ml-2" style="display: flex">
                        <input type="radio" id="system-radio" <?php echo e($tags['selected']['tagtype'] == 2?"checked":""); ?> disabled class="mt-1 mr-3"> <span> <h5>Organization Tag</h5></span>
                    </div>
                    <div class="ml-2" style="display: flex">
                        <input type="radio" id="system-radio" <?php echo e($tags['selected']['tagtype'] == 3?"checked":""); ?> disabled class="mt-1 mr-3"> <span> <h5>Personal Tag</h5></span>
                    </div>
                </div>
        </div>
        <div class="row mt-2">
        ...
        <div class="mt-2">
            ...
            <div>
                <span class="ml-2" <?php echo e($system != 1?"id=tagNoteEdit":""); ?> style="font-size: 14px"><?php echo e($tags['selected']['note']); ?></span>
                <?php if($system != 1): ?>
            ...
            <div>
                <span id="tagDescriptionEdit" class="ml-2" style="font-size: 14px"><?php echo e($tags['selected']['description']); ?></span>
        ...
        <div style="text-align: center; margin-top: 100px">
            ...
            <a href="<?php echo e(route('tag.delete',['tagID'=>$selected])); ?>"class="btn btn-brand btn-icon-sm" id="tagDelete" aria-expanded="false" style="display: none">
